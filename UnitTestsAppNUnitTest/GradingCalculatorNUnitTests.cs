...
namespace UnitTestsAppNUnitTest
{
    ...
    public class GradingCalculatorNUnitTests
    {
        ...
        [TestCase(65, 55)]
        [TestCase(50, 90)]
        public void GradeCalc_IFailureScenarios_GetFGrade(int score, int attendance)
        {
        ...
        public string GradeCalc_AllGradeLogicalScenarios_GetOutput(int score, int attendance)
        {
            gradingCalculator.Score = score;
            gradingCalculator.AttendancePercentage = attendance;
